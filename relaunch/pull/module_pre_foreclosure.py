"""Pre-foreclosure distress module (POST /v2/PropertySearch)."""
...
DEFAULT_OUTPUT_FILENAME = "PreForeclosures.csv"
GROUP_KEY = "apn"
MODULE_NAME = "pre_foreclosure"
...
def build_payload(
    ...
    return {
        ...
        "pre_foreclosure_date_min": date_min,
        "pre_foreclosure_date_max": date_max,
